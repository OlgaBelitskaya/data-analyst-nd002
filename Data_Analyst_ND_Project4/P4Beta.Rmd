...
##### Second, let us have a look on dataframe components (1128 observations of 23 variables; their types, values, etc.). Most of them have a numerical type.
...
```{r fig.width=11, fig.height=5, echo=FALSE, message=FALSE, warning=FALSE, Multivariate_Plots_1}
...
##### The first final plot is a graphical table of correlation between variables. It emphasizes once again the strong relationship between almost all indicators in the data.
