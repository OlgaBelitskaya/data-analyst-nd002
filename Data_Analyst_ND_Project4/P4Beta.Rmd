...
```{r fig.width=14, fig.height=8, Univariate_Plots_5}
...
```{r fig.width=14, fig.height=8, Univariate_Plots_10}
...
```{r fig.width=14, fig.height=8, Univariate_Plots_15}
...
pl4 <- layout(pl3, title = 
                "Prices for Gold, Silver, Platinum and Dual Currency Basket",
...
```{r fig.width=9, fig.height=6, Multivariate_Plots_5}
